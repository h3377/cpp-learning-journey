// #11 II 3 CHECK  MATRICES Equality.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
bool IsMatrixEqual(int Matrix1[3][3], int Matrix2[3][3], short Rows, short Col)
{
    return(sumOfMatrix(Matrix1, Rows, Col) == sumOfMatrix(Matrix2, Rows, Col));
}
...
{ 
    ...
    if(IsMatrixEqual(Matrix,Matrix2,3,3))
