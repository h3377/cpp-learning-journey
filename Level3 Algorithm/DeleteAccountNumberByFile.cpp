// #50 II 3 Delete Client By Account Number.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
bool DeleteClientsByAccountNumber(string AccountNumber, vector<sClient>& vClient)
{
	sClient Client;
	char Answer = 'n';
