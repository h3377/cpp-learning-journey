// #43 II3 Replace Word(custom).cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
    string S1 = "Welcome to Qatar , Qatar is a nice country";
    string StringToReplace = "Qatar";
    string ReplaceTo = "Yeman";
    cout << "\nOriginal String:\n" << S1;
